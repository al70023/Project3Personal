...
function Inventory() {
    ...
    const handleAddFormSubmit = (event) => {
        ...
        fetch('https://node-deployment-bjd4.onrender.com/inventory/insert', requestOptions)
            .then(res => res.json())
    ...
    const handleEditFormSubmit = (event) => {
        ...
        fetch('https://node-deployment-bjd4.onrender.com/inventory/update', requestOptions)
            .then(res => res.json())
    ...
    const handleDeleteClick = (inventory_id) => {
        ...
        fetch(`https://node-deployment-bjd4.onrender.com/inventory/${inventory_id}`, { method: 'DELETE' })
    ...
    const fetchInventory = () => {
        ...
        fetch('https://node-deployment-bjd4.onrender.com/Inventory')
            .then(res => res.json())
